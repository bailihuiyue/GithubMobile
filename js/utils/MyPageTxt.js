...
export const MyPageTxt = {
    ...
    Sort_Language: {name: '语言排序', IconGroup: MaterialCommunityIcons, icon: 'sort'},
    Custom_Theme: {name: '自定义主题', IconGroup: Ionicons, icon: 'ios-color-palette'},
    Custom_Key: {name: '自定义标签', IconGroup: Ionicons, icon: 'md-checkbox-outline'},
